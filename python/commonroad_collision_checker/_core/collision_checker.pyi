...
class CollisionCheckerBuilder:
    ...
    def with_static_obstacle(self, collision_object: CollisionObject) -> None: ...
    def with_dynamic_obstacle(self, dynamic_obstacle: DynamicObstacle) -> None: ...
    def with_road_boundary_obstacle(self, lanelets: List[List[Tuple[float, float]]]) -> None: ...
