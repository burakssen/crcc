...
def road_boundary(lanelet_network: Any) -> CollisionObject: ...
def commonroad_polygon(polygon: Any) -> CollisionObject: ...
def commonroad_shape(shape: Any) -> CollisionObject: ...
def commonroad_occupancy(occupancy: Any) -> CollisionObject: ...
def shapely_geometry(geometry: Any) -> CollisionObject: ...
